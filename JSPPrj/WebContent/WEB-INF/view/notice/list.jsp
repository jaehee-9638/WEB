...
<body>
			...
			<div class="search-form margin-top first align-right">
				...
				<form class="table-form">
					<fieldset>
						...
						<select name="f">
							<option ${(param.f=="title")?"selected":"" } value="title">제목</option><!-- param.f값이 title이면 드롭다운메뉴 고정되도록  -->
							<option ${(param.f=="writer_id")?"selected":"" } value="writer_id">작성자</option><!-- 오라클에서의 컬럼명과 같아야함  -->
						</select> 
						<label class="hidden">검색어</label>
						<input type="text" name="q" value="${param.q }"/> <!-- value에 값넣어준건 검색한 후에도 검색창에 검색했던 내용 남아있게  -->
			...
			<div class="notice margin-top">
				...
				<table class="table">
					...
					<tr>
						...
						<td>
						<fmt:formatNumber value="${n.hit }"></fmt:formatNumber>
						</td>
					</tr>
					</c:forEach>
					<%-- <% }%> --%>
	...
	<c:set var ="lastNum" value="23"></c:set><!-- 일단 임의 값 넣어줌 -->
	<div>
